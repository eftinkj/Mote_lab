...
/**
 * @brief __delay_cycles() correctly accounts for various system clock speeds.
 */
...
#define APPLICATION_IMAGE_START ((uint32_t) &__ApplicationFlashStart)
#define APPLICATION_IMAGE_END ((uint32_t)   &__ApplicationFlashEnd)
...
#define RAM_END ((uint32_t) &__RAMEnd)
extern char __RAMStart;
 ...
 */
#define WEAK_VARIABLE(var) var __attribute__((weak))
...
/**
 * @brief Place variable into .noinit section.
 * .
 */
#define NOINIT(var) var/* __attribute__ ((section (__NO_INIT__)))*/

/**
 ...
 ===============================================================================
   ...
   (#) Notes on algorithm behavior:
       ...
       - Offset and length must be supplied in bytes.       - All data in NVM storage must exist above the mgmt bytes, denoted by
         NVM_MGMT_SIZE_B.
...
/** @defgroup  nvm_Private_Functions_prototypes
  * @{
  */

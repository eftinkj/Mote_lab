...
/******************************************************************************/
/* Many of the common definitions must be explicitly enabled by the particular*/
/*                  PLATFORM_HEADER being used                                */
/******************************************************************************/

#ifdef _HAL_USE_COMMON_PGM_

/** @addtogroup Master Program Memory Declarations
...
/** @addtogroup Divide and Modulus Operations
...
/**@addtogroup C Standard Library Memory Utilities
...
/**
  ...
  */
void halCommonMemCopy(void *dest, const void *src, uint16_t bytes);
...
/**@addtogroup Bit Manipulation Macros
  *@{
  */
...
/**@addtogroup Byte Manipulation Macros
  *@{
  */
...
/**@addtogroup Time Manipulation Macros
  *@{
  */

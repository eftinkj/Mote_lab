...
/** @defgroup MB950_LOW_LEVEL 
  * @brief This file provides firmware functions to manage Leds, push-buttons, 
  *        COM ports, Mems on SPI and temperature sensor (LTLM20) on ADC available
  *        on MB950 board from STMicroelectronics.
  * @{
  */

/** @defgroup MB950_LOW_LEVEL_Private_TypesDefinitions
  * @{
  */

/* Uncomment the line below according to the MB950 board revision used.
  */
...
/** @defgroup MB950_LOW_LEVEL_Private_Defines
  * @{
  */
...
/** @defgroup MB950_LOW_LEVEL_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup MB950_LOW_LEVEL_Private_Variables
  * @{
  */
GPIO_TypeDef* GPIO_PORT[LEDn] = {LED1_GPIO_PORT, LED3_GPIO_PORT};
const uint16_t GPIO_PIN[LEDn] = {LED1_PIN, LED3_PIN};

GPIO_TypeDef* BUTTON_PORT[BUTTONn] = {S1_BUTTON_GPIO_PORT, S2_BUTTON_GPIO_PORT,
                                      S3_BUTTON_GPIO_PORT, S4_BUTTON_GPIO_PORT,
                                      S5_BUTTON_GPIO_PORT};

const uint16_t BUTTON_PIN[BUTTONn] = {S1_BUTTON_PIN, S2_BUTTON_PIN, S3_BUTTON_PIN,
                                      S4_BUTTON_PIN, S5_BUTTON_PIN};

const uint16_t BUTTON_EXTI_IRQn[BUTTONn] = {S1_BUTTON_EXTI_IRQn, S2_BUTTON_EXTI_IRQn,
                                            S3_BUTTON_EXTI_IRQn, S4_BUTTON_EXTI_IRQn,
                                            S5_BUTTON_EXTI_IRQn};

const uint16_t BUTTON_EXTI_SOURCE[BUTTONn] = {S1_BUTTON_EXTI_SOURCE, S2_BUTTON_EXTI_SOURCE,
                                              S3_BUTTON_EXTI_SOURCE, S4_BUTTON_EXTI_SOURCE,
                                              S5_BUTTON_EXTI_SOURCE};

const uint16_t BUTTON_IRQn[BUTTONn] = {S1_BUTTON_IRQn, S2_BUTTON_IRQn, S3_BUTTON_IRQn,
                                       S4_BUTTON_IRQn, S5_BUTTON_IRQn};
...
/** @defgroup MB950_LOW_LEVEL_Private_FunctionPrototypes
  * @{
  */
...
/** @defgroup MB950_LOW_LEVEL_Private_Functions
  * @{
  */
...
/**
  ...
  *   This parameter can be one of following parameters:
  *     @arg BUTTON_S1: Push Button S1
  *     @arg BUTTON_S2: Push Button S2
  *     @arg BUTTON_S3: Push Button S3
  *     @arg BUTTON_S4: Push Button S4
  *     @arg BUTTON_S5: Push Button S5
...
{
  /* Return the push button status on MB950 board */

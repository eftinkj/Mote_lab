/**
  ******************************************************************************
  * @file    mbxxx_i2c_lis302dl.h
  * @author  MCD Application Team
  * @version V1.0.1
  * @date    30-November-2012
  * @brief   This file contains all the functions prototypes for the mbxxx_i2c_lis302dl.c
  *          firmware driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef __MBXXX_I2C_LIS302DL_H
#define __MBXXX_I2C_LIS302DL_H
...
/** @defgroup MBXXX_I2C_LIS302DL_Exported_Types
  * @{
  */
...
/** @brief LIS302DL High Pass Filter struct 
  */
typedef struct
{
...
/** @brief Mems data type: three acceleration values each related to a specific direction
  * Watch out: only lower data values are currently used by the device */
...
typedef struct
{
  ...
  uint8_t outz_l;
  uint8_t outz_h;
}LIS302DL_DataTypeDef;

/**
  * @}
  */
  
/** @defgroup MBXXX_I2C_LIS302DL_Exported_Constants
  * @{
  */

/* Uncomment the following line to use the default LIS302DL_TIMEOUT_UserCallback() 
   function implemented in mbxxx_i2c_lis302dl.c file.
...
#define LIS302DL_LONG_TIMEOUT         ((uint32_t)(10 * LIS302DL_FLAG_TIMEOUT))
#define LIS302DL_TIMEOUT              ((uint32_t)0x100)


#define LIS302DL_OK                    0
#define LIS302DL_FAIL                  1   
/******************************************************************************/
...
*******************************************************************************/
#define LIS302DL_OUT_X_ADDR_L                  0x28
#define LIS302DL_OUT_X_ADDR_H                  0x29
...
*******************************************************************************/
#define LIS302DL_OUT_Y_ADDR_L                  0x2A
#define LIS302DL_OUT_Y_ADDR_H                  0x2B
...
*******************************************************************************/
#define LIS302DL_OUT_Z_ADDR_L                  0x2C
#define LIS302DL_OUT_Z_ADDR_H                  0x2D
...
/**
 ...
 /** @defgroup Settings for STATUS_REG
  * @{
  */
...
/** @defgroup MBXXX_I2C_LIS302DL_Exported_Functions
  * @{
  */ 
...
/* LIS302DL_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in mbxxx_i2c_lis302dl.h file.

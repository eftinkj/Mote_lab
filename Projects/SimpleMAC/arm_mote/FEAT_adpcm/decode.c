 ...
 * CCITT ADPCM decoder
 *
 * Usage : decode [-2|-3|4|5] [-a|u|l] < infile > outfile
 */
#include <stdio.h>
#include "g72x.h"
...
fprintf(stderr, "\tdecode [-2|-3|4|5] [-a|u|l] < infile > outfile\n");
fprintf(stderr, "where:\n");
fprintf(stderr, "\t-2\tProcess G.726 16kbps (2-bit) input data\n");
